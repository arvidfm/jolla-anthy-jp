...
/*    '-': 'ー', '~': '〜', '.': '。', ',': '、', '[': '「', ']': '」',
    ...
    'kw': 'け', 'kr': 'け', 'sw': 'せ', 'sr': 'せ', 'tw': 'て',
    'tr': 'て', 'hw': 'へ', 'hr': 'へ',
    'mw': 'め', 'mr': 'め', 'yw': 'いぇ', 'yr': 'いぇ', 'rw': 'れ',
    'wr': 'うぇ', 'gw': 'げ', 'gr': 'げ', 'zw': 'ぜ', 'zr': 'ぜ',
    'dw': 'で', 'dr': 'で', 'bw': 'べ', 'br': 'べ',
    'fw': 'ふぇ', 'fr': 'ふぇ', 'chw': 'ちぇ', 'chr': 'ちぇ', 'tyw': 'ちぇ', 'tyr': 'ちぇ', 
     'lw': 'ぇ', 'lr': 'ぇ', 'xw': 'ぇ', 'xr': 'ぇ', 
    'jw': 'じぇ', 'jr': 'じぇ', 'vw': 'ゔぇ', 'vr': 'ゔぇ',
    'ks': 'か', 'kp': 'こ', 'sp': 'そ', 'ts': 'た',
    'tp': 'と', 'hs': 'は', 'hp': 'ほ',
    'ms': 'ま', 'mp': 'も', 'ys': 'や', 'yp': 'よ', 'rp': 'ろ', 'rs': 'rs', 
    'ws': 'わ', 'wp': 'を', 'gs': 'が', 'gp': 'ご', 'zs': 'ざ', 'zp': 'ぞ',
    'ds': 'だ', 'dp': 'ど', 'bs': 'ば', 'bp': 'ぼ', 
    'ls': 'ぁ', 'lp': 'ぉ', 'xs': 'ぁ', 'xp': 'ぉ',
    'js': 'じゃ', 'jp': 'じょ', 'vs': 'ゔぁ', 'vp': 'ゔぉ'
}
